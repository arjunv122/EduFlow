...
import { Mail, ArrowLeft, Sun, Moon, ShieldCheck, CheckCircle2, Loader2 } from 'lucide-react';
      ...
      <div style={S.card}>
        {sent ? (
          <div style={{ textAlign: 'center' }}>
            ...
            <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.4rem', color: 'var(--text-primary)', margin: '0 0 0.5rem' }}>Check Your Email</h1>
            ...
            <Link to="/login" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: 'var(--accent)', fontSize: '0.875rem', fontWeight: 600, textDecoration: 'none' }}>
          ...
          <>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '2rem' }}>
              ...
              <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.4rem', color: 'var(--text-primary)', margin: 0 }}>Forgot Password</h1>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem', marginBottom: '1rem' }}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <input
                    ...
                    placeholder="your.email@sret.edu.in"
